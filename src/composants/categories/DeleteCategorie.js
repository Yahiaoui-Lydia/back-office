  ...
  count++;
    ...
    const deleteAdmin = async (id) => {
        ...
        let csrfToken = localStorage.getItem('csrfToken')
           await axios.delete(process.env.REACT_APP_API_DeleteCategorie+'/'+id, { headers: {
    ...
    return (
      ...
      >
        ...
        <div style={{'fontSize':'16px'}}>Êtes-vous sûr de vouloir supprimer les categories suivantes ?</div>
