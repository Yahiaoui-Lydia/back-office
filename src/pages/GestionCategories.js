...
function GestionCategories() {
  ...
  const actions = <div style={{'width':'100%'} }><label htmlFor="search" className='bi bi-search btn-tab '></label><input id="search" type="text" onChange={handleSearch} className='search' placeholder='Rechercher par catégorie ,catégorie parente' /> 
   <OverlayTrigger placement="bottom" overlay={<Tooltip >Ajouter une nouvelle catégorie</Tooltip>} >
    ...
    <div className="main">
      ...
      />
        ...
        <DataTable
                    ...
                    contextMessage={{ singular: 'catégorie', plural: 'catégories', message: 'sélectionnée(s)'} }
                    noDataComponent="Aucune catégorie n'est trouvée"
